...
import pl.edu.agh.dsm.catalog.core.usecase.GetResources;
import pl.edu.agh.dsm.catalog.web.infrastructure.SystemResourceAssemblerSupport;
...
public class SystemResourcesController {
	...
	public Resources<Resource<SystemResource>> getList() {
