...
public class HttpClientUtil {
	...
	public static HttpResponseResult makePostRequest(String uri, HttpEntity data, Credentials userCredential) throws IOException {
		HttpPost httppost = new HttpPost(uri);
		httppost.setEntity(data);
		return makeRequest(httppost, userCredential);
	}
	
	public static HttpResponseResult makeGetRequest(String uri, Credentials userCredential) throws IOException {
		HttpGet httpget = new HttpGet(uri);
		return makeRequest(httpget, userCredential);
	}
	
	public static HttpResponseResult makeDeleteRequest(String uri, Credentials userCredential) throws IOException {
		HttpDelete httpdelete = new HttpDelete(uri);
		return makeRequest(httpdelete, userCredential);
	}
	
	private static CredentialsProvider prepareCredenitalsProvider(URI uri, Credentials credentials) throws IOException {
		if(credentials == null) {
			return null;
		}
