...
@UseCase("UC_PF_MT4F")
public class UCDeleteComplexMeasurementImpl implements
		UCDeleteComplexMeasurement {
	...
	@Autowired
	public UCDeleteComplexMeasurementImpl(CatalogueProxy catalogueProxy,
			MeasurementPermisionResolver measurementPermisionResolver,
			MeasurementRepository measurementRepository) {
	...
	public ActionPossibility havePermission(UUID uuid) {
		...
		return ActionPossibilityImpl.makeDecision(havePerm,
